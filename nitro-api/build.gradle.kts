...
dependencies {
    ...
    api("io.sentry:sentry:8.12.0") // Nitro
...
tasks.withType<Javadoc>().configureEach {
    (options as StandardJavadocDocletOptions).addStringOption("-add-modules", "jdk.incubator.vector") // Nitro - our javadocs need this for pufferfish's SIMD patch
